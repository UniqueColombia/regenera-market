...
**Plantilla de Supabase:** *Magic Link*
**Se dispara cuando:** alguien que **ya tiene cuenta** pide entrar desde
`/entrar` — porque escribió bien su contraseña desde un aparato que no
reconocemos, o porque pidió el código directamente.

> **Esta plantilla y la 01 tienen que decir lo mismo.** Es el par que hay que
> mantener sincronizado: `signInWithOtp` elige una u otra según el usuario
> exista o no.
          ...
          <tr>
            <td style="padding:12px 32px 8px 32px;">
              ...
              <p style="margin:14px 0 0 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif; font-size:16px; line-height:1.6; color:#55655c;">
                Alguien pidió entrar a Seregenera con este correo. Si fuiste tú,
                escribe este código en la pantalla que dejaste abierta:
              </p>
            </td>
          </tr>
...
## Por qué te llega esto aunque tengas contraseña

No es un fallo: es el segundo factor. Seregenera pide el código **solo cuando el
aparato no se reconoce** — la primera vez desde un computador nuevo, o después de
borrar las cookies. En los siguientes accesos desde ese mismo aparato basta la
contraseña.

Quien quiera dejar de confiar en un aparato lo hace desde `/cuenta`.
