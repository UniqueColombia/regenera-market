...
**Plantilla de Supabase:** *Invite user*
**Se dispara cuando:** un administrador crea una cuenta desde el panel de
Supabase, o `scripts/crear-admin.mts` corre con `--avisar`.

> **Una cuenta creada así no tiene contraseña.** `requireUser()` la manda a
> `/cuenta/clave` a ponerse una antes de dejarla usar nada — ver `src/lib/auth.ts`.
> El texto de abajo se lo avisa para que no la pille por sorpresa.

## Asunto

```
Te invitaron a Seregenera
```
...
<head>
  ...
  <title>Te invitaron a Seregenera</title>
</head>
<body style="margin:0; padding:0; background-color:#f0ebe2;">

  <div style="display:none; max-height:0; overflow:hidden; opacity:0; mso-hide:all;">
    Tu código para activar la cuenta: {{ .Token }}
  </div>
          ...
          <tr>
            <td style="padding:12px 32px 8px 32px;">
              ...
              <p style="margin:14px 0 0 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif; font-size:16px; line-height:1.6; color:#55655c;">
                Alguien del equipo de Seregenera creó una cuenta con este correo.
                Para activarla, escribe este código en
                <a href="{{ .SiteURL }}/entrar" style="color:#1b5b3d; font-weight:bold;">{{ .SiteURL }}/entrar</a>:
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:28px 32px 0 32px;">
              ...
              <p style="margin:20px 0 0 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif; font-size:13px; line-height:1.6; color:#55655c;">
                Al entrar te vamos a pedir que elijas una contraseña: la cuenta se
                creó sin ninguna. Si no esperabas esta invitación, ignora el
                correo — sin el código nadie entra, y el código vence solo.
              </p>
            </td>
          </tr>
