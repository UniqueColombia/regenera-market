...
description: Cuándo extraer un componente en Regenera Market, dónde ponerlo, y cómo decidir entre Server Component y Client Component. Úsala antes de crear cualquier archivo en src/components/ o de agregar "use client" a algo, y cuando una página empiece a pasar de ~150 líneas de JSX.
---
...
por las que este proyecto existe en Next.js (ver hito
[0001](../../hitos/0001-mvp-navegable.md)).
